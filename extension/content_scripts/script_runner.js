/**
 * Script Runner - Custom Scripts Execution Engine
 * 
 * This content script is responsible for:
 * 1. Loading user's custom scripts that match the current URL
 * 2. Providing the aiAssistant API to scripts
 * 3. Executing scripts in a sandboxed context
 * 4. Managing script lifecycle and cleanup
 * 
