...
> - [Slash Command System](../../features/slash_command_system.md) — full command catalog, autocomplete, `/enable_*`, `/model_*`, `/agent_*`, `/preamble_*`, backend endpoint `GET /api/slash_commands`
