...
5. **M5 (lifecycle & polish):** **D2/D3 (consolidation + entity resolution) DONE 2026-06-10.** Remaining: F1 (move the ready dormancy/expiry sweep to a periodic background job) + F4 (notifications), G2-task, G3-task, H4 safeguards.
