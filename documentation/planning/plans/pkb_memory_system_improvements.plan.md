...
5. **M5 (lifecycle & polish):** **D2/D3 (consolidation + entity resolution) + F1/F4 (scheduled sweep + notifications) + G3-task (export/import + audit log) DONE 2026-06-10.** Remaining: G2-task (batch enrichment), H4 safeguards.
