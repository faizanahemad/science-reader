...
**Status:** DONE — Backend complete (routing, config, autonomy.py, REST endpoints, MCP tools, activity log). UI landed 2026-06-13 (slider, preview, facet overrides, auto-save on change).
**Created:** 2026-06-12
**Owner:** PKB / TMS
