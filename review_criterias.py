review_params = {
    ...
    "review_parameters_medium" : [
        ...
        ("Methodology and Experimental Design", "How appropriate and valid are the methods used? Are the experimental setup and data analysis rigorous and reliable?"),

        ("Data Analysis", "How is the statistical analysis handled?"),

        ("Relevance and Significance", "Does the research address an important and relevant problem in the field? What is its potential impact?"),

        ("Citations and References", "Is there an appropriate citation of previous work? How is the quality and relevance of the references?"),

        ("Ethical Considerations", "Are ethical standards and guidelines upheld in the research?"),

        ("Reproducibility", "Does the paper provide sufficient information for replication of the results or reproduction of the experiments?"),

        ("Hypothesis and Objectives", "Is the research question or hypothesis clear and valuable?"),

        ("Contextualisation", "Is the problem or research question well situated within the broader scientific discourse?"),

        ("Use of Theories or Frameworks", "Is there an effective use of existing theories or frameworks to structure the research?"),

        ("Results and Interpretation", "Are the results clear and are their conclusions justified by the data?"),

        ("Robustness Checks", "Does the paper provide checks for its main results to see if they hold under different assumptions or slight changes in the methodology?"),

        ("Visual Presentation of Data", "How clear and effective are the graphs, tables, and other visual presentations of data?"),

        ("Discussion and Implications", "Are the results considered in the wider context of the field? Are implications for future research clearly outlined?"),

        ("Identified Limitations", "Are the limitations of the paper and their impact on the findings and interpretations clearly outlined?"),

        ("Scientific Rigour and Integrity", "Does the paper adhere to principles such as the appropriate use of statistics, transparent reporting of methods and data, declaration of conflicts of interest?"),

        ("Importance and Application", "How significant is the research? Is it addressing a critical problem? Can the results be applied in practice or further research?"),

        ("Strength and Weakness", "What are the strong and weak points of the paper?"),

        ("Theoretical Validity", "Is the theory or model used in the research sound, logical, and based on established scientific principles?"),
        ...
        ("Experimental Validity", "Do the experiments effectively test the research question or hypothesis? Can the results be generalized?"),
        ...
        ("Proposal of Alternative Approaches", "Are there any alternative approaches proposed to overcome identified weaknesses or limitations?"),
