...
SMALL_CHUNK_LEN = 192
LARGE_CHUNK_LEN = 512
TOKEN_LIMIT_FOR_DETAILED = os.getenv("TOKEN_LIMIT_FOR_DETAILED", 13000)
TOKEN_LIMIT_FOR_SHORT = os.getenv("TOKEN_LIMIT_FOR_SHORT", 2800)
MODEL_TOKENS_SMART = os.getenv("MODEL_TOKENS_SMART", 8000)
MODEL_TOKENS_DUMB = os.getenv("MODEL_TOKENS_DUMB", 4000)
